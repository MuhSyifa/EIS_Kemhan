    ...
    <div class="pageheader">
        ...
        <div class="breadcrumbs">
            <ol class="breadcrumb">
                ...
                <li class="active">Warga Lainnya</li>
            </ol>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="main">
        <menu class="no-print">
            ...
            <a href="<?php echo base_url(''); ?>komcad/warga_lainnya">
                <button type="button" class="btn btn-greensea">WN LAINNYA</button>
            </a>
        </menu>
                  ...
                  <div class="front"> 
                    ...
                    <div class="media">        
                      ...
                      <div class="media-body">
                        <medium><b>Total Tenaga Ahli</b></medium>
                        <h2 class="media-heading animate-number" data-value="22.779" data-animation-duration="1500">0</h2></div>
                    </div> 
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header">
                          <h3><strong>Statistik</strong> Sumber Daya Alam Warga Lainnya Berdasarkan Provinsi</h3>
                          <div class="controls">
                        ...
                        <!-- tile body -->
                        <div class="tile-body">
                          <table class="table table-hover sdmWargaLainnya_provinsi" style="width: 100%; font-size:13px" id="sdm_provinsi">
                              <thead>
                                <tr>
                                  <th>No</th>
                                  <th>Provinsi</th>
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        ...
                        <!-- tile header -->
                        <div class="tile-header">
                          <h3><strong>Statistik</strong> Sumber Daya Alam Warga Lainnya Berdasarkan Sub Bidang</h3>
                          <div class="controls">
                              <a href="#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                              <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                              <a href="#" class="remove"><i class="fa fa-times"></i></a>
                        ...
                        <!-- tile body -->
                        <div class="tile-body">
                          <table class="table table-hover sdmWargaLainnya_subBidang" style="width: 100%; font-size:13px" id="sdm_subBidang">
                              <thead>
                                <tr>
                                  <th>No</th>
                                  <th>Sub Bidang</th>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <!-- tile header -->
                        <div class="tile-header">
                          <h3><strong>Statistik</strong> Sumber Daya Warga Lainnya</h3>
                          <div class="controls">
                              <a href="#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                              <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                              <a href="#" class="remove"><i class="fa fa-times"></i></a>
                        ...
                        <!-- tile body -->
                        <div class="tile-body">
                          <div class="SdmWargaLainnyaKomduk" style="width: 100%" id="SdmWargaLainnyaKomduk"></div>
                        </div>
                        <!-- /tile body -->
