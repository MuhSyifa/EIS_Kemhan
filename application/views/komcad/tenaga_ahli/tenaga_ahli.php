    ...
    <div class="main">
        <menu class="no-print">
            ...
            <a href="<?php echo base_url(''); ?>komcad/tenaga_ahli">
                <button type="button" class="btn btn-greensea">TENAGA AHLI</button>
            </a>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header">
                          <h3><strong>Statistik</strong> Sumber Daya Alam Tenaga Ahli Berdasarkan Provinsi</h3>
                          <div class="controls">
                        ...
                        <!-- tile body -->
                        <div class="tile-body">
                          <table class="table table-hover sdmTenagaAhli_provinsi" style="width: 100%; font-size:13px" id="sdm_provinsi">
                              <thead>
                                <tr>
                                  <th>No</th>
                                  <th>Provinsi</th>
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        ...
                        <!-- tile header -->
                        <div class="tile-header">
                          <h3><strong>Statistik</strong> Sumber Daya Alam Tenaga Ahli Berdasarkan Sub Bidang</h3>
                          <div class="controls">
                              <a href="#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                              <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                              <a href="#" class="remove"><i class="fa fa-times"></i></a>
                        ...
                        <!-- tile body -->
                        <div class="tile-body">
                          <table class="table table-hover sdmTenagaAhli_subBidang" style="width: 100%; font-size:13px" id="sdm_subBidang">
                              <thead>
                                <tr>
                                  <th>No</th>
                                  <th>Sub Bidang</th>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <!-- tile header -->
                        <div class="tile-header">
                          <h3><strong>Statistik</strong> Sumber Daya Tenaga Ahli</h3>
                          <div class="controls">
                              <a href="#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                              <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                              <a href="#" class="remove"><i class="fa fa-times"></i></a>
                        ...
                        <!-- tile body -->
                        <div class="tile-body">
                          <div class="SdmTenagaAhliKomduk" style="width: 100%" id="SdmTenagaAhliKomduk"></div>
                        </div>
                        <!-- /tile body -->
