          <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation collapsed" id="bela_negara">
                <a href="#" class="sidebar-toggle" data-toggle="#bela_negara">BELA NEGARA <i class="fa fa-angle-up"></i></a>
                <ul class="menu">
                  <li>
                    <a href="<?php echo base_url(''); ?>bela_negara">
                      <i class="fa fa-pie-chart"></i> Laporan Statistik & Chart
                    </a>
                  </li>
                </ul>
              </li>

              <li class="navigation collapsed" id="komcad">
                <a href="#" class="sidebar-toggle" data-toggle="#komcad">KOMCAD <i class="fa fa-angle-up"></i></a>
                
                <ul class="menu">
                  
                  <li>
                    <a href="<?php echo base_url(); ?>komcad/sdm">
                      <i class="fa fa-users"></i> SDM BIN
                    </a>
                  </li>

                  <li>
                    <a href="<?php echo base_url(); ?>komcad/sdab">
                      <i class="fa fa-tint"></i> SDAB
                    </a>
                  </li>
                  
                  <li>
                    <a href="<?php echo base_url(); ?>komcad/sarpras_in">
                      <i class="fa fa-th"></i> SARPRASNAS
                    </a>
                  </li>
              ...
              <li class="navigation collapsed" id="komduk">
                <a href="#" class="sidebar-toggle" data-toggle="#komduk">KOMDUK <i class="fa fa-angle-up"></i></a>
                
                <ul class="menu">
                  
                  <li>
                    <a href="<?php echo base_url(); ?>komduk/sdm">
                      <i class="fa fa-users"></i> SDM
                    </a>
                  </li>

                  <li>
                    <a href="<?php echo base_url(); ?>komduk/sdab">
                      <i class="fa fa-tint"></i> SDAB
                    </a>
                  </li>
              ...
              <li class="navigation collapsed" id="tekindhan">
                <a href="#" class="sidebar-toggle" data-toggle="#tekindhan">TEKINDHAN <i class="fa fa-angle-up"></i></a>
                <ul class="menu">
                  <li>
                    <a href="<?php echo base_url(''); ?>tekindhan">
                      <i class="fa fa-pie-chart"></i> Statistik & Chart
                    </a>
                  </li>
                </ul>
              </li>

              <li class="navigation collapsed" id="veteran">
                <a href="#" class="sidebar-toggle" data-toggle="#veteran">VETERAN <i class="fa fa-angle-up"></i></a>
                <ul class="menu">
                  <li>
                    <a href="<?php echo base_url(''); ?>veteran">
                      <i class="fa fa-pie-chart"></i> Statistik & Chart Berdasarkan Babin
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(''); ?>veteran/triwulan">
                      <i class="fa fa-pie-chart"></i> Statistik & Chart Per-Triwulan
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(''); ?>veteran/summary_kep_babin">
                      <i class="fa fa-pie-chart"></i> Summary KEP Per-Babin
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="navigation collapsed" id="master">
                <a href="#" class="sidebar-toggle" data-toggle="#master">Administrator <i class="fa fa-angle-up"></i></a>
                <ul class="menu">
                  <li>
